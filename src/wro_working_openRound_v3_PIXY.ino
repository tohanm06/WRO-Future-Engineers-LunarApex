...
int distance1 = 0;
double sel(char ret,int i){
  double reat;
  switch (ret){
  case 'l':{
    
   reat = pixy.ccc.blocks[i].m_height;
   
    break;
  }
  case 'w':{
     
     reat =pixy.ccc.blocks[i].m_width;
  ...
  case 's':{
    ...
    reat =pixy.ccc.blocks[i].m_signature;
    break;
    }  
    case 'x':{
    
   reat =pixy.ccc.blocks[i].m_x;
    break;
    }
  case 'y':{
    
    reat =pixy.ccc.blocks[i].m_y;
    break;
  }
  case 'i':{
   
   reat =pixy.ccc.blocks[i].m_index;
    break;
  }
  case 'a':{
    
    reat =pixy.ccc.blocks[i].m_age;
    break;
  }
...
double distance(int trig,int echo) {
  ...
  double distancei = duration * 0.034 / 2;
